...
func (c *greeterClient) SayGoodbye(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloResponse)
...
func (UnimplementedGreeterServer) SayGoodbye(context.Context, *HelloRequest) (*HelloResponse, error) {
